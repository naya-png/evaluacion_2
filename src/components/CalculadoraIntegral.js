...
function CalculadoraIntegral() {
  ...
  return (
    <section id="demo" className="py-4">
      <div className='container mt-4' id='demo-calculadora'>
        <div className='row'>
          <div className='col-12'>
            <h2 className="fw-bold text-start mb-0">DEMO Calculadora</h2>
            <p className="text-muted mb-3" style={{ color: '#797979ff', textAlign: 'right' }} >
